...
CLI validator for unpacked SitePack v0.2.0 packages on PHP 8.1+. It validates manifest, catalog, artifacts, and NDJSON against draft 2020-12 JSON Schema and writes `reports/validate.json`.
